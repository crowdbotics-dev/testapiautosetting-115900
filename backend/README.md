...
## Project Structure
    ...
    ├── testapiautosetting_115900  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115900`
...
2. Clone this repo and `cd testapiautosetting_115900`
